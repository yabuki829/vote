...
export const isVotedStyle1 = "flex relative justify-between cursor-default items-center h-6 md:h-8"
//未投票時にホバーした時色が変わる様にするやつ
export const isNotVotedStyle1 = "flex relative justify-between hover:bg-gray-200 items-center h-6 md:h-8"
